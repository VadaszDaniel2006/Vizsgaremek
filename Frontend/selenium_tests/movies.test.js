...
async function moviesTesztek() {
    ...
    try {
        ...
        // 14. TESZT: Hero szekció betöltése (featured-section az App.jsx-ben)
        ...
        // 18. TESZT: Film részleteinek megnyitása (Info Modal)
        await driver.get('http://localhost:8090/');
        ...
        // JAVÍTÁS: A ModalManager által nyitott modalt várjuk
        ...
        // 19. TESZT: Modal leírás ellenőrzése (info-desc a ModalManager.jsx-ben)
        ...
        // 20. TESZT: Visszatérés (Modal bezárása és logó)
