...
async function extraTesztek() {
    ...
    try {
        ...
        // Megvárjuk a profilképet a Navbarban
        let profilAvatar = await driver.wait(until.elementLocated(By.css('.nav-right img')), 10000);
        await driver.sleep(2000); 
        console.log("...Belépve.");

        // 29. TESZT: Profil szerkesztő megnyitása
        await profilAvatar.click();
        await driver.sleep(1000); // Megvárjuk a ProfilDropdown lenyílását
        
        // Megkeressük a "Profil szerkesztése" opciót a dropdownban
        let editLink = await driver.wait(until.elementLocated(By.xpath("//*[contains(text(), 'Profil szerkesztése')]")), 5000);
        await editLink.click();
        
        // JAVÍTÁS: A ProfileEditor.jsx-ben lévő osztályokat keressük
        ...
        // Bezárjuk a ProfileEditort
        await driver.findElement(By.css('.profile-close-modal')).click();
        await driver.sleep(1000);

        // 30. TESZT: Kedvencek Sidebar
        await profilAvatar.click();
        await driver.sleep(1000);
        let favLink = await driver.wait(until.elementLocated(By.xpath("//*[contains(text(), 'Kedvenceim')]")), 5000);
        await favLink.click();
        
        // A Sidebar megnyílását ellenőrizzük (Sidebar.css/jsx alapján az osztály valószínűleg .sidebar-container vagy .sidebar)
